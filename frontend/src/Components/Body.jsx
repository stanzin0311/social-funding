...
const Body = () => {
  ...
  return (
    <div className="bg-[#2c363f] text-white p-2 rounded-sm shadow-md backdrop-filter backdrop-blur-xl bg-opacity-60 border-[1px] border-gray-500 h-[100%]">
      <section className="border-b-2 border-white sm:flex sm:flex-row sm:justify-between sm:items-center p-2 flex flex-col gap-y-5 sm:gap-y-0 w-[100%]">
        <header>
          <span
            ...
            className="bg-[#3c6498] rounded-xl p-2 cursor-pointer hover:bg-sky-500 hover:ring-sky-500"
          >
            Create Campaign
          </span>
        </header>
        ...
        <header className="flex gap-x-2 ">
          <Link
            to="/signup"
            className="bg-[#3c6498]  hover:bg-sky-500 hover:ring-sky-500 rounded-xl p-2 cursor-pointer"
          >
            SignUp
          </Link>
          <Link
              ...
              ? Data?.data?.map((Each, Ind) => {
                  return (
                    <Link
                      to={`/project/${Ind}`}
                      key={Ind}
                      className="p-2 flex flex-col gap-2 border-[1px] hover:bg-sky-500 border-blue-500 w-[100%] sm:w-[20%] flex-wrap"
                    >
                      <MediaRenderer
                        src={Each[2]}
